...
<p>内訳を見ると、収益の68%を旅行思い出マップが占めています。広告のeCPMは728円と悪くない。ただ、そもそも収益化の仕組みが入っているアプリが数本しかありません。ダウンロードも月1,253件では絶対量が足りない。</p>
...
""",
    ...
    },
    {
        ...
        "highlights": [
            ("旅行思い出マップ", "¥67,816", "ダウンロードが前月の4.2倍、3,826件まで伸びた。1年間サポータープランが32件売れてサブスクだけで54,532円。広告は13,284円。"),
...
<p>要因ははっきりしています。旅行思い出マップのダウンロードが903件から3,826件まで伸びました。年末は今年の旅行を振り返りたくなる時期で、このアプリと相性がいい。そして増えたダウンロードの分だけサブスクも素直についてきた。中でも1年間サポータープランが32件売れたのが大きくて、これは1年分の売上を先にもらえる契約です。</p>
...
""",
    ...
    },
    {
        ...
        "highlights": [
            ("旅行思い出マップ", "¥60,214", "ダウンロードは5,228件とさらに増加。サブスクで44,488円、広告で15,624円。そしてAndroid版がGoogle Playで初めての売上102円を記録した。"),
...
""",
    ...
    },
    {
        ...
        "desc": "2026年2月の収益は215,002円で前月の2.3倍。うんちくんが月2万ダウンロード近くまで跳ね、年額ワンタイムオファーが54件刺さった。",
        "highlights": [
            ("うんちくん", "¥88,914", "ダウンロードが月19,504件まで跳ねた。年額ワンタイムオファーが54件で44,982円、広告も43,932円。一気に大黒柱になった。"),
...
<p>主役は完全にうんちくんです。海外でダウンロードが跳ねて月2万件近く。そこへ先月のNextActionで実装した年額ワンタイムオファーが54件刺さりました。毎日記録するアプリなので広告収益も同時に伸びる。ダウンロードの爆発、初回限定オファー、毎日開くアプリ。この三拍子が揃うとこうなります。</p>
...
""",
    ...
    },
    {
        ...
        "highlights": [
            ("推しアイランド", "¥610,430", "ダウンロード36,700件の大バズ。約3,000円の買い切りプランが217本売れて547,103円。週間プランも1,281件動いた。単月で60万円を超えた。"),
            ("うんちくん", "¥199,091", "App Storeで61,633円、広告で134,126円、Playで3,332円。ダウンロード20,145件と成長が続く。"),
...
<p>立役者は推しアイランドです。SNSでバズってダウンロードが36,700件まで跳ね、約3,000円の買い切りプランが217本売れました。買い切りの強さは、バズの熱をその場で現金にできることです。サブスクなら初月分しか入らない熱量が、一撃で入ってくる。</p>
...
""",
    ...
    },
    {
        ...
        "highlights": [
            ("うんちくん", "¥174,115", "App Storeで86,099円、広告で86,231円、Playで1,785円。ダウンロード31,645件。正規の年額プランも32,805円売れて、単体で月17万円の柱になった。"),
...
""",
    ...
    },
    {
        ...
        "highlights": [
            ("うんちくん改め UNCHIKUN: Poop Log & AI Health", "¥177,806", "AI健康記録アプリに進化して名前も変えた。App Storeで62,131円、広告で106,284円、Playで9,391円。ダウンロードは33,652件。"),
...
<p>先月の宣言どおり、うんちくんにAI機能を載せてUNCHIKUN: Poop Log & AI Healthに進化させました。名前にAIを入れたことでストアでの見え方が変わり、ダウンロードは33,652件。単体で月17.8万円を稼ぎ、柱の座を固めています。</p>
...
""",
    ...
    },
    {
        ...
        "desc": "2026年6月の収益は341,961円。うんちくんは月3万ダウンロード超え。上半期の合計240万円もあわせて振り返る。",
        "highlights": [
            ("うんちくん", "¥172,736", "ダウンロードは月32,412件。App Storeで47,129円、iOS広告で105,988円、Android広告で15,909円、Playで3,710円。"),
...
<p>うんちくんのダウンロードは月32,412件。iOSとAndroidの広告、iOSとAndroidの課金という4つの財布から収益が入る、理想的なマルチプラットフォームアプリになっています。</p>
...
""",
    ...
    {
        "ym": "2026-07", "date": "2026-07-31", "label": "2026年7月",
        "admob": 167118, "appstore": 195845, "play": 9356,
        "total": 372319, "mom": "+8.9", "rate": "3.72",
        "desc": "2026年7月の収益は372,319円。新規ダウンロードは横ばいのまま広告だけが伸び、新しく出した5本の売上はゼロだった。",
        "highlights": [
            ("うんちくん", "¥230,630", "iOSの新規ダウンロードは32,579件で前月と横ばい。App Storeの課金75,211円に、iOS広告128,666円、Android広告20,385円、Playの6,368円が乗る。月収の62%を1本で稼いだ計算になる。"),
            ("旅行思い出マップ", "¥80,989", "課金70,425円に広告7,878円とPlay2,686円。新規ダウンロードは3,139件で前月から少し減った。夏の旅行シーズンの割に静かだった。"),
            ("7月に出した新作5本", "¥0", "DiveKeep、コインゲームコレクション、Himekuri、OshiLog、あなたレシート。新規ダウンロードは4件から29件、5本合わせて56件。売上は1円も立っていない。"),
        ],
        "analysis": """
<p>372,319円。前月から8.9%増えて、4ヶ月続けて月30万円台に乗りました。</p>
<p>増えた分はほとんど広告です。AdMobが167,118円で、うんちくんのiOSだけで128,666円。表示回数は867,281回まで伸びました。広告の月収としては2019年7月に初めて21円を受け取ってから3番目に高い月で、上回っているのは推しアイランドがバズった今年3月と、2022年3月の2回だけです。</p>
<p>面白いのは、新しく入れてくれた人が増えていないことです。うんちくんの新規ダウンロードは6月の32,412件に対して7月は32,579件。App Store全体でも39,240件から38,972件で、ほとんど動いていません。それでも広告の表示回数は16%伸びました。増えていたのは再ダウンロードのほうで、21,681件から54,873件へ2.5倍になっています。機種を変えたか、一度消してまた入れ直したか。どちらにしても、すでに知っている人が戻ってきて、前より多く開いた月でした。</p>
<p>課金は195,845円で横ばいです。広告は既にいる人の利用が増えれば伸びますが、課金はそうはいかない。今月の形はそこに出ています。</p>
<p>もうひとつ、集中の度合いが気になります。うんちくんと旅行思い出マップの2本で月収の84%。7月は新作を5本出しましたが、売上はどれもゼロで、ダウンロードが2桁に届かないものもありました。出す手は止めません。ただ、出しただけでは何も起きないと数字がはっきり言っています。</p>
""",
        "next_actions": [
            "うんちくんの広告フォーマットを見直す。eCPM148円が1割上がるだけで月1万円以上変わる",
            "うんちくんのペイウォールを出す場所を変えて、増えたダウンロードを課金につなげる",
            "7月に出した5本のうちダウンロードが動いているものだけに絞って、ASOをやり直す",
        ],
    ...
    },
    {
        ...
        "desc": "2026年8月の収益は494,888円。7月に売上ゼロだったあなたレシートが9万円を超え、うんちくんの新規ダウンロードは3割減った。",
        "highlights": [
            ("うんちくん", "\u00a5213,898", "App Storeの課金77,664円に、iOS広告116,051円、Android広告16,096円、Playの4,087円。新規ダウンロードは22,445件で7月の32,579件から31%減ったのに、課金は75,211円から77,664円へ増えた。"),
            ("旅行思い出マップ", "\u00a5114,753", "課金98,475円は単月で自己最高。1年間サポータープランが44,879円を占める。新規ダウンロードも3,139件から4,707件へ5割伸びて、広告とPlayを足すと11万円を超えた。"),
            ("あなたレシート", "\u00a594,640", "7月は新規ダウンロード8件で売上ゼロ。8月はiOSに1,985件入って、3,000円の買い切りプランが72,327円。Android版も16,709円が立った。"),
        ],
        "analysis": """
<p>494,888円。前月から32.9%増えました。3月の104万円に次いで2番目に高い月です。</p>
<p>3月は推しアイランドが1本で跳ねた月でした。8月は形が違って、10万円前後の柱が3本同時に立っています。うんちくんが213,898円、旅行思い出マップが114,753円、あなたレシートが94,640円。この3本で月収の85%です。</p>
<p>あなたレシートは7月号で売上ゼロと書いた5本のうちの1本でした。7月の新規ダウンロードは8件です。8月はiOSに1,985件入って、3,000円の買い切りプランが72,327円。Androidでも16,709円。ダウンロード1件あたりに直すと47.7円で、同じ月のうんちくんは9.5円でした。無料で長く使ってもらって広告を出すのと、2,000人に3,000円を売るのとで、ここまで変わる。</p>
<p>そのうんちくんは新規ダウンロードが3割減りました。32,579件から22,445件。広告収益も128,666円から116,051円へ下がっています。ただ、eCPMは148円から154円に上がり、課金は75,211円から77,664円に増えました。ダウンロード1件あたりの課金は2.31円から3.46円です。7月のNextActionに広告の見直しとペイウォールの位置変更を書いていて、数字はどちらも上を向きました。何がどれだけ効いたかまでは切り分けられていません。</p>
<p>8月に出した新作は7本。nokki、Monivo、Yattayo、EyeMole、Matchbox、パンケーキ屋さん、Music Snapshotで、7本合わせて新規ダウンロードは711件、売上は557円でした。先月と同じ光景です。ただ7月に同じことを書いた5本のうち1本が、翌月に9万円を持ってきました。出した月の数字では何も分からない。</p>
""",
        "next_actions": [
            "あなたレシートで売れた3,000円の買い切りを、他のアプリのペイウォールにも置いて試す",
            "うんちくんのダウンロードを戻す。広告の単価は上がったので、あとは母数が効く",
            "8月に出した7本のストア文言と最初の画面を、9月のうちに一度ずつ直す",
        ],
        "closing": "出した月の数字では、当たりかどうか分からない。9月も出しながら、先月の7本を触ります。",
    },
]
...
<head>
    ...
    <!-- 背景を抜いているので、暗いタブバーでは黒が溶ける。そこだけ白抜きに差し替える -->
    <link rel="icon" type="image/png" sizes="32x32" href="/assets/icons/favicon-dark-32x32.png" media="(prefers-color-scheme: dark)">
    <link rel="icon" type="image/png" sizes="16x16" href="/assets/icons/favicon-dark-16x16.png" media="(prefers-color-scheme: dark)">
    ...
    <style>
        ...
        .goal-progress-fill {{ background: var(--color-ink); height: 100%; border-radius: 999px; min-width: 4px; }}
        ...
        .app-highlight.shadow-purple {{ box-shadow: 5px 5px 0 var(--color-ink); }}
        .app-highlight.shadow-cyan {{ box-shadow: 5px 5px 0 var(--color-ink); }}
        .app-highlight.shadow-pink {{ box-shadow: 5px 5px 0 var(--color-ink); }}
        .app-highlight.shadow-yellow {{ box-shadow: 5px 5px 0 var(--color-ink); }}
        ...
        .series-link {{ display: block; background: var(--color-surface); border: 2px solid var(--color-ink); box-shadow: 4px 4px 0 var(--color-ink); border-radius: 12px; padding: 14px 20px; margin: var(--spacing-lg) 0; text-decoration: none; color: var(--color-primary); font-weight: 700; transition: transform 0.3s ease, box-shadow 0.3s ease; }}
        .series-link:hover {{ transform: translate(-3px, -3px); box-shadow: 7px 7px 0 var(--color-ink); }}
