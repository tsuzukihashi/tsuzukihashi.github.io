...
""",
    ...
    },
    {
        ...
        "desc": "2026年7月の収益は372,319円。うんちくんのダウンロードが月8万件を超えて広告が伸びた一方、新しく出した5本の売上はゼロだった。",
        "highlights": [
            ("うんちくん", "¥230,630", "iOSのダウンロードが82,207件。App Storeの課金75,211円に、iOS広告128,666円、Android広告20,385円、Playの6,368円が乗る。月収の62%を1本で稼いだ計算になる。"),
            ("旅行思い出マップ", "¥80,989", "課金70,425円に広告7,878円とPlay2,686円。ダウンロードは6,242件で前月とほぼ同じ。夏の旅行シーズンの割に静かだった。"),
            ("7月に出した新作5本", "¥0", "DiveKeep、コインゲームコレクション、Himekuri、OshiLog、あなたレシート。ダウンロードは5件から29件にとどまり、売上は1円も立っていない。"),
        ],
        "analysis": """
...
<p>元をたどればダウンロードです。うんちくんのiOSは6月の49,363件から82,207件へ。App Store全体でも93,845件で、初めて月9万件を超えました。ところが課金は195,845円と横ばいのままです。ダウンロードが1.5倍になっても課金が動かないということは、無料で使って広告を見る人の比率が上がったということになります。広告が伸びたのは嬉しいけれど、単価の低いほうに寄っている。</p>
...
""",
    ...
    },
    {
        ...
        "highlights": [
            ("うんちくん", "\u00a5213,898", "App Storeの課金77,664円に、iOS広告116,051円、Android広告16,096円、Playの4,087円。ダウンロードは45,702件で7月の82,207件から半減したのに、課金は75,211円から77,664円へ増えた。"),
            ("旅行思い出マップ", "\u00a5114,753", "課金98,475円は単月で自己最高。1年間サポータープランが44,879円を占める。ダウンロードも6,242件から8,265件へ伸びて、広告とPlayを足すと11万円を超えた。"),
            ("あなたレシート", "\u00a594,640", "7月はダウンロード8件で売上ゼロ。8月はiOSに2,055件入って、3,000円の買い切りプランが72,327円。Android版も16,709円が立った。"),
        ],
        "analysis": """
...
<p>あなたレシートは7月号で売上ゼロと書いた5本のうちの1本でした。7月のダウンロードは8件です。8月はiOSに2,055件入って、3,000円の買い切りプランが72,327円。Androidでも16,709円。ダウンロード1件あたりに直すと46円で、同じ月のうんちくんは4.7円でした。無料で長く使ってもらって広告を出すのと、2,000人に3,000円を売るのとで、ここまで変わる。</p>
<p>そのうんちくんはダウンロードが半分になりました。82,207件から45,702件。広告収益も128,666円から116,051円へ下がっています。ただ、eCPMは148円から154円に上がり、課金は75,211円から77,664円に増えました。ダウンロード1件あたりの課金は0.91円から1.70円です。7月のNextActionに広告の見直しとペイウォールの位置変更を書いていて、数字はどちらも上を向きました。何がどれだけ効いたかまでは切り分けられていません。</p>
<p>8月に出した新作は7本。nokki、Monivo、Yattayo、EyeMole、Matchbox、パンケーキ屋さん、Music Snapshotで、売上は合わせて557円でした。先月と同じ光景です。ただ7月に同じことを書いた5本のうち1本が、翌月に9万円を持ってきました。出した月の数字では何も分からない。</p>
""",
        "next_actions": [
