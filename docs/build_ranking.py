      ...
      gtag('config', 'G-QERPQ1EGLH');
        ...
        <style>
            ...
            .rk-total {{
                ...
                border: 2px solid var(--rk-ink); border-radius: 18px; box-shadow: 8px 8px 0 var(--rk-yellow);
                padding: 18px 30px;
            }}
            .rk-total b {{
            ...
            .rk-podium:nth-child(1) {{ box-shadow: 9px 9px 0 var(--rk-purple); }}
            .rk-podium:nth-child(2) {{ box-shadow: 9px 9px 0 var(--rk-cyan); }}
            .rk-podium:nth-child(3) {{ box-shadow: 9px 9px 0 var(--rk-pink); }}
